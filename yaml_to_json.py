...
if len(sys.argv) > 1:
    ...
    if os.path.exists(sys.argv[1]):
        ...
        source_content = yaml.safe.load(source_file)
        source_file.close()
...
# No file, no usage
    ...
    print("Usage: yaml_to_json.py <source_file.json> [target_file.yaml]")

# Processing the conversion
output1 = json.dumps(source_content, indent=2)
